...
export const adminNavItems = [
  ...
  { href: "/admin/ajo-types", label: "Ajo Types", icon: ListChecks },
...
export const alerts = [
  [
    ...
    "24 requests in the last hour",
    "2 min ago",
  ],
  [
    "Medium",
    "Failed transfer cluster",
    "7 card deposits failed from one issuer",
    "18 min ago",
  ],
  ...
  [
    ...
    "NGN 2.8M deposit flagged for review",
    "3 hrs ago",
  ],
]
...
export const notifications = [
  [
    "System update",
    "New withdrawal review policy is ready for admins.",
    "Delivered",
    "May 18, 2026",
  ],
  [
    "Broadcast",
    "Contribution streak reminder sent to 1,284 users.",
    "Delivered",
    "May 17, 2026",
  ],
  [
    "Alert",
    "Suspicious activity notice sent to compliance.",
    "Queued",
    "May 17, 2026",
  ],
]
